...
with endurance_tab:
    ...
    with t_5km_3c:
        ...
        st.write(pd.read_csv('data/ranking_M_3c_5km.csv'))
    with t_5km_4b:
    ...
    with t_hmar_3c:
        ...
        st.write(pd.read_csv('data/ranking_M_3c_Half_Marathon.csv'))
    with t_hmar_4b:
    ...
    with t_mar_3c:
        ...
        st.write(pd.read_csv('data/ranking_M_3c_Marathon.csv'))
    with t_mar_5b:
...
with middle_distance_tab:
    ...
    with t_800_4b:
        ...
        st.write(pd.read_csv('data/ranking_M_4b_800m.csv'))
    # 1500m
    with t_1500_3b:
    ...
    with t_mile_3c:
        ...
        st.write(pd.read_csv('data/ranking_M_3c_Mile.csv'))
    with t_mile_4b:
...
with sprints_tab:
    ...
    with t_100_3c:
        ...
        st.write(pd.read_csv('data/ranking_M_3c_100m.csv'))
    with t_100_4b:
    ...
    with t_200_3c:
        ...
        st.write(pd.read_csv('data/ranking_M_3c_200m.csv'))
    with t_200_4b:
    ...
    with t_400_3c:
        ...
        st.write(pd.read_csv('data/ranking_M_3c_400m.csv'))
    with t_400_4b:
    ...
    with t_4x100_3c:
        ...
        st.write(pd.read_csv('data/ranking_M_3c_4x100m.csv'))
    with t_4x400_3b:
